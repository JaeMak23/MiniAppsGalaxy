...
val CustomLightMode: ImageVector
    get() {
        if (_customLightMode != null) return _customLightMode!!

        _customLightMode = ImageVector.Builder(
            name = "light_mode",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        return _customLightMode!!
    }

private var _customLightMode: ImageVector? = null