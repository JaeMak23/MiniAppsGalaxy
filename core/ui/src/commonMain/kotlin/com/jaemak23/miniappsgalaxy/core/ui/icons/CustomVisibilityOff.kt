...
val CustomVisibilityOff: ImageVector
    get() {
        if (_customVisibilityOff != null) return _customVisibilityOff!!

        _customVisibilityOff = ImageVector.Builder(
            name = "visibility_off",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(
                ...
                curveToRelative(-0.37f, 0f, -0.72f, 0.05f, -1.07f, 0.14f)
                close()
                moveTo(2.01f, 3.87f)
        ...
        return _customVisibilityOff!!
    }

private var _customVisibilityOff: ImageVector? = null