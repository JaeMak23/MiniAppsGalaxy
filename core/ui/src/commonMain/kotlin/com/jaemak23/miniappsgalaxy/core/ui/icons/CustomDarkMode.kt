...
val CustomDarkMode: ImageVector
    get() {
        if (_customDarkMode != null) return _customDarkMode!!

        _customDarkMode = ImageVector.Builder(
            name = "dark_mode",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
        ...
        return _customDarkMode!!
    }

private var _customDarkMode: ImageVector? = null