...
import com.jaemak23.miniappsgalaxy.core.ui.components.AppScaffold
import com.jaemak23.miniappsgalaxy.core.ui.components.gamecomponents.GameTopBarWithExit
...
fun Game2048Screen(
    ...
    AppScaffold(
        ...
        topBar = {
            GameTopBarWithExit(title = "2048", onExit = onBack) {
                IconButton(onClick = { onAction(Game2048Action.Restart) }) {
